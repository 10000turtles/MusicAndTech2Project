...
#include "../src/inc/MidiFile.h"
#include "../src/inc/Options.h"
...
void  createHenon(double alpha, double beta, double x0, double y0, int maxcount, MidiFile& midifile);
...
void createHenon(double alpha, double beta, double x0, double y0e, int maxcount, MidiFile& midifile)
{
  double x           = x0;
  double y           = y0e;
  int    termination = 0;
